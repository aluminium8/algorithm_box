...
int main()
{
    ...
    std::cout << "first, I'LL input correct string to the test function" << std::endl<< std::endl;
    please_input_Hello_world("Hello_world");

    std::cout << "second, I'LL input mistaken string to the test function" << std::endl<< std::endl;
